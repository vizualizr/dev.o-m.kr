	...
	- ### Measure
		- ```js
		  ...
		  d3.csv("file.csv", d=> {
		    ...
		    // ! d3.csv() returns an Promise Object.
		    // ! The actual data being returned to the method, `then()` is 
		    // ! an array of the returned value, 
		    // ! here it is an object with three pairs of keys and values. 
		    return {
		      key1: d.key1,
		      key2: +d.key2,
		    ...
		    // ! the data is Array Object, a standard JavaScript Objeect 
		  }).then(data => {
