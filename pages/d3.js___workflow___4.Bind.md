	...
	- ### d3.js workflow
		...
		- Structuring Data
		  logseq.order-list-type:: number
			- Format
			  logseq.order-list-type:: number
			- [Measure]([[d3.js/workflow/3.structuring data/a.measure]])
			  logseq.order-list-type:: number
		- **==[Bind]([[d3.js/workflow/4.Bind]])==**
		  logseq.order-list-type:: number
...
- ## Steps
	- ### Bind
		...
		- #### Data Bining to DOM Elements
			- `d3.selectAll()`
				- [selectAll()]([[d3.js/selectAll()]])은 원칙적으로 DOM 요소를 선택하고 조작한다. 선택하고자 하는 DOM요소가 존재할 때와 그렇지 않을 때 작동 순서가 약간 다르다. 해당 문서를 참고하라. 
				  id:: 68f06566-727c-402f-889f-527b3d3cf386
...
- ## log
	- [[2025-07-26]]
	- [[2025-10-16]] Continuation of the previous study.
- ### References
