...
- ## Steps
	- ### 전체 워크플로는 아래와 같다.
		...
		- {{renderer :drawio, 1780994403998.svg}}
	- ### 준비물은 아래와 같다.
		...
		- #### 파이 그래프 제도를 위한 제도 데이터 `annotatedData`
		  logseq.order-list-type:: number
			...
			- ```js
			  ...
			  ```
			- 결과는 아래와 같은 그래프 초안이다.
			- ![localhost_5173_d3-in-action_05_5.1-Pie_layout_started_.png](../assets/localhost_5173_d3-in-action_05_5.1-Pie_layout_started_1779813627258_0.png){width 600}
	- ### 레이블 및 기타 요소 추가
		- 일단 레이블부터 단다.
		- 지금 코드는 아래와 같다. 색상 지정까지 마친 코드다.
			- ```js
